...
collider_sphere Collider_Sun = new collider_sphere;
collider_sphere Collider_Mercury = new collider_sphere;
collider_sphere Collider_Venus = new collider_sphere;
collider_sphere Collider_Earth = new collider_sphere;
collider_sphere Collider_Mars = new collider_sphere;
collider_sphere Collider_Jupiter = new collider_sphere;
collider_sphere Collider_Saturn = new collider_sphere;
collider_sphere Collider_Uranus = new collider_sphere;
collider_sphere Collider_Neptune = new collider_sphere;
collider_sphere Collider_Pluto = new collider_sphere;

// MM -- set up for player collider
collider_AABB Player = new collider_AABB;
...
GLfloat light_position[] = { 512000, 0, 0, 1.0 };
GLfloat sun_colour[] = { 0.5,0.5,0.0,1.0 };
...
void myinit()
{
	...
	glLightModelfv(GL_LIGHT_MODEL_AMBIENT, sun_colour);
...
void UpdateCamCollider()
{
    ...
    x = (float) glGetDoubleV(cam.GetLR());
    y = (float) glGetDoubleV(cam.GetUD());
    z = (float) glGetDoubleV(cam.GetFB());
    
    collisionInit_B(Player, x, y, z, 10.0, 10.0); //MM - the size (10, 10) is a guess for size
...
void CreateTextures()
{
	...
	*/
	...
	tp.CreateTexture(PLANETS_SUN, image, 3000, 1500);

	image = tp.LoadTexture("data/planets_mercury.raw", 1024, 520);
	tp.CreateTexture(PLANETS_MERCURY, image, 1024, 520);

	image = tp.LoadTexture("data/planets_venus.raw", 2048, 1024);
	tp.CreateTexture(PLANETS_VENUS, image, 2048, 1024);

	image = tp.LoadTexture("data/planets_earth.raw", 2048, 1024);
	tp.CreateTexture(PLANETS_EARTH, image, 2048, 1024);

	image = tp.LoadTexture("data/planets_mars.raw", 2048, 1024);
	tp.CreateTexture(PLANETS_MARS, image, 2048, 1024);

	image = tp.LoadTexture("data/planets_jupiter.raw", 1440, 720);
	tp.CreateTexture(PLANETS_JUPITER, image, 1440, 720);

	image = tp.LoadTexture("data/planets_saturn.raw", 2880, 1440);
	tp.CreateTexture(PLANETS_SATURN, image, 2880, 1440);

	image = tp.LoadTexture("data/planets_uranus.raw", 2048, 1024);
	tp.CreateTexture(PLANETS_URANUS, image, 2048, 1024);

	image = tp.LoadTexture("data/planets_neptune.raw", 1024, 512);
	tp.CreateTexture(PLANETS_NEPTUNE, image, 1024, 512);

	image = tp.LoadTexture("data/planets_pluto.raw", 1024, 512);
	tp.CreateTexture(PLANETS_PLUTO, image, 1024, 512);

	image = tp.LoadTexture("data/planets_saturnrings.raw", 1024, 1024);
	tp.CreateTexture(PLANETS_SATURNRINGS, image, 1024, 1024);
	...
	gluQuadricDrawStyle(quad, GLU_FILL); // MM
	gluQuadricTexture(quad, GL_TRUE); // MM
	gluQuadricNormals(quad, GLU_SMOOTH); // MM
...
void DisplayPlanets()
{
	if (LevelNum > 0)
	{
        ...
        CollisionInit_S(&Collider_Sun, allPlanets[0][0], allPlanets[0][1] * SizeMult, allPlanets[0][2] * SizeMult, allPlanets[0][3] * SizeMult); // MM - Position setup for collider sphere
		...
		CollisionInit_S(&Collider_Mercury, allPlanets[1][0] * SizeMult + SunX, allPlanets[1][1] * SizeMult, allPlanets[1][2] * SizeMult); // MM - Position setup for collider sphere
		...
		CollisionInit_S(&Collider_Venus, allPlanets[2][0] * SizeMult + SunX, allPlanets[2][1] * SizeMult, allPlanets[2][2] * SizeMult); // MM - Position setup for collider sphere
		...
		CollisionInit_S(&Collider_Venus, allPlanets[3][0] * SizeMult + SunX, allPlanets[3][1] * SizeMult, allPlanets[3][2] * SizeMult); // MM - Position setup for collider sphere
	...
	if (LevelNum > 1)
	{
		...
		CollisionInit_S(&Collider_Mars, allPlanets[4][0] * SizeMult + SunX, allPlanets[4][1] * SizeMult, allPlanets[4][2] * SizeMult); // MM - Position setup for collider sphere
		...
		CollisionInit_S(&Collider_Jupiter, allPlanets[5][0] * SizeMult + SunX, allPlanets[5][1] * SizeMult, allPlanets[5][2] * SizeMult); // MM - Position setup for collider sphere
		...
		CollisionInit_S(&Collider_Saturn, allPlanets[6][0] * SizeMult + SunX, allPlanets[6][1] * SizeMult, allPlanets[6][2] * SizeMult); // MM - Position setup for collider sphere
	...
	if (LevelNum > 2)
	{
		...
		CollisionInit_S(&Collider_Uranus, allPlanets[7][0] * SizeMult + SunX, allPlanets[7][1] * SizeMult, allPlanets[7][2] * SizeMult); // MM - Position setup for collider sphere
		...
		CollisionInit_S(&Collider_Neptune, allPlanets[8][0] * SizeMult + SunX, allPlanets[8][1] * SizeMult, allPlanets[8][2] * SizeMult); // MM - Position setup for collider sphere
		...
		CollisionInit_S(&Collider_Pluto, allPlanets[9][0] * SizeMult + SunX, allPlanets[9][1] * SizeMult, allPlanets[9][2] * SizeMult); // MM - Position setup for collider sphere
...
void TeleportToPlanets()
{
    ...
    collisionOffset_B(&Player, (float) SunX, (float) allPlanets[0][1], (float) glGetDoubleV(cam.GetFB())) // MM - moves collider box
